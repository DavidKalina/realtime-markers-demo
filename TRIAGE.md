...
### 3. Itinerary Completion Celebration
...
### 4. Streak + Badge Push Notifications
...
### 6. Year-in-Review / Monthly Recaps
...
### 8. Trail-Aware Itinerary Generation
**Impact:** High | **Effort:** ~3 hours | **Risk:** Low
...
**What to build:**
- During itinerary generation, query Overpass for trails *between* stops (not just as stops)
...
### 10. Contextual Trail Suggestions at Check-In
...
### 11. Trail Stats in Personal Log
...
### 12. Shared Itineraries (Adopt & Co-Track)
...
Phase 2: The Accountability Bridge (~11 hours)
  1. Calendar Integration + Reminders       (4 hours)  ← #1 PRIORITY
  2. Intention-Based Itinerary Generation   (3 hours)
  3. Itinerary Completion Celebration       (2 hours)
  4. Streak/Badge Push Notifications        (2 hours)

Phase 3: Make the Record Beautiful (~10 hours)
  5. Photo Memories at Check-Ins            (3 hours)
  6. Year-in-Review / Monthly Recaps        (4 hours)
  7. Monthly Activity Calendar              (3 hours)

Phase 4: Trail Intelligence (~7 hours)
  8. Trail-Aware Itinerary Generation       (3 hours)
  9. Coffee + Trail Quick Template          (1 hour)
  10. Contextual Trail Suggestions          (2 hours)
  11. Trail Stats in Personal Log           (1 hour)

Phase 5: Growth & Social (when ready, ~10 hours)
  12. Shared Itineraries (Adopt & Co-Track) (5 hours)
  13. Ritual Streaks                        (2 hours)
  14. Unify Leaderboard Ranking             (1 hour)
```
