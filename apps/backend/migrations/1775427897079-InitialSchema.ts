...
export class InitialSchema1775427897079 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_fab14d780032ed8a450ba22175" ON "coverage_clusters" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "coverage_snapshots" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "cells_geojson" jsonb, "canvas_geojson" jsonb, "coverage_pct" numeric(5,2) NOT NULL DEFAULT '0', "territory_sq_miles" numeric(10,3) NOT NULL DEFAULT '0', "avg_density" numeric(4,3) NOT NULL DEFAULT '0', "frontier_miles" numeric(10,3) NOT NULL DEFAULT '0', "cluster_count" integer NOT NULL DEFAULT '0', "directional_gaps" jsonb, "computed_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_3335a348b92d3e535d8c5080e2a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_00b3e02a384367a2ffd869df9e" ON "coverage_snapshots" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "goal_reflections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "milestone" character varying(50) NOT NULL, "journal_entry" text NOT NULL, "journal_prompt" text, "percent_elapsed" smallint, "remaining_days" smallint, "completed_quest_count" smallint, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_goal_reflections" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_goal_reflections_user_id" ON "goal_reflections" ("user_id")`,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "pathways" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "theme" character varying(200) NOT NULL, "theme_label" character varying(200), "venue_categories" text array NOT NULL DEFAULT '{}', "avg_resonance" numeric(4,3) NOT NULL DEFAULT '0', "quest_count" integer NOT NULL DEFAULT '0', "current_difficulty" smallint NOT NULL DEFAULT '1', "difficulty_trend" numeric(4,3) NOT NULL DEFAULT '0', "phase" character varying(10) NOT NULL DEFAULT 'bfs', "sidequest_ids" uuid array NOT NULL DEFAULT '{}', "resonance_scores" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_bfba58a2ba7d08c64412da85630" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_3dd477a6ca21bc16000b848f3a" ON "pathways" ("user_id") `,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_9f4b7d96ca2fc123fc7a1a1f4d6') THEN ALTER TABLE "objectives" ADD CONSTRAINT "FK_9f4b7d96ca2fc123fc7a1a1f4d6" FOREIGN KEY ("sidequest_id") REFERENCES "sidequests"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_355e721ad4888fb5fd6b22baad2') THEN ALTER TABLE "sidequests" ADD CONSTRAINT "FK_355e721ad4888fb5fd6b22baad2" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_a614a14953814ddb38e5dd84fab') THEN ALTER TABLE "sidequests" ADD CONSTRAINT "FK_a614a14953814ddb38e5dd84fab" FOREIGN KEY ("parent_id") REFERENCES "sidequests"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_e90b1cf8e432be7336a0f39b10a') THEN ALTER TABLE "users" ADD CONSTRAINT "FK_e90b1cf8e432be7336a0f39b10a" FOREIGN KEY ("active_sidequest_id") REFERENCES "sidequests"("id") ON DELETE SET NULL ON UPDATE NO ACTION; END IF; END $$`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_7ad1e7f0a4616a2998d921cb12f') THEN ALTER TABLE "user_push_tokens" ADD CONSTRAINT "FK_7ad1e7f0a4616a2998d921cb12f" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_1fed4b95dc47cd40bc7b9a4db7a') THEN ALTER TABLE "objective_checkins" ADD CONSTRAINT "FK_1fed4b95dc47cd40bc7b9a4db7a" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_d2c6161407fbcf3704edffb29f5') THEN ALTER TABLE "objective_checkins" ADD CONSTRAINT "FK_d2c6161407fbcf3704edffb29f5" FOREIGN KEY ("sidequest_id") REFERENCES "sidequests"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_6e9d5077858c2cac00c89fa7827') THEN ALTER TABLE "objective_checkins" ADD CONSTRAINT "FK_6e9d5077858c2cac00c89fa7827" FOREIGN KEY ("objective_id") REFERENCES "objectives"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_f1221d9b1aaa64b1f3c98ed46d3') THEN ALTER TABLE "user_badges" ADD CONSTRAINT "FK_f1221d9b1aaa64b1f3c98ed46d3" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$`,
    );
  }
