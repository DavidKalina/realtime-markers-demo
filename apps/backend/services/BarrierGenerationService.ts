...
export async function generateBarriers(openAIService: OpenAIService, input: GenerateBarriersInput): Promise<GenerateBarriersResult> {
  ...
  validateBarriers(parsed.barriers);

  return { barriers: parsed.barriers };
}

function validateBarriers(barriers: GeneratedBarrier[]): void {
