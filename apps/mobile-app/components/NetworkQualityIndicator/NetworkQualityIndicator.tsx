...
const SLIDE_IN = SlideInLeft.springify().damping(20).mass(1.2).stiffness(150);
const SLIDE_OUT = SlideOutLeft.springify().damping(20).mass(1.2).stiffness(150);
